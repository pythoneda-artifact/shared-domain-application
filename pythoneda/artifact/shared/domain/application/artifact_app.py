...
"""
pythoneda/artifact/shared/domain/application/artifact_app.py
...
class ArtifactApp(LocalArtifactApp):
    ...
    Collaborators:
        - Command-line handlers from pythoneda-artifact/domain-infrastructure
    """
    ...
    def __init__(self):
        ...
        try:
            from pythoneda.artifact.shared.domain.application.artifact_banner import (
                ArtifactBanner,
            )
...
if __name__ == "__main__":
    asyncio.run(
        ArtifactApp.main("pythoneda.artifact.shared.domain.application.ArtifactApp")
    )
